...
namespace NFePHP\ECF\Tests;

use NFePHP\ECF\Elements\Z0000;
...
class Z0000Test extends TestCase
{
    public function testZ0001()
    {
        ...
        $expected = '|0000|LECF|01012015|31122015|EMPRESA TESTE|11111111000199|AM||3434401|99999||0|1|0||0|0||N|N|0|0|1|';
